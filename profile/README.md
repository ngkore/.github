...
> NgKore Foundation is officially an Associate Member of ***Linux Foundation Networking(LFN)***

NgKore Foundation is an open-source community driving innovation across **Quantum Safe Network, Post-Quantum Cryptography (PQC), eBPF, 5G Advanced, 6G, O-RAN, NTN, AI/ML, Blockchain,** and **Quantum Simulations**. NgKore Foundation is more than just a project—it's a global, open ecosystem where collaboration fuels innovation. At the heart of NgKore Foundation is a commitment to *openness* and *interoperability*. 

*"NgKore Foundation is India's first open source community that works on Post Quantum Cryptography and eBPF"*
...
NgKore Foundation is sustained entirely through self-funded, bootstrapped efforts. Our progress is made possible through strong collaborations with academic institutions and industry partners, who support us with access to advanced testing infrastructure and resources.
You can support our work by sponsoring NgKore Foundation, your help sustain a vibrant open-source ecosystem committed to innovation, transparency, and global collaboration. Your support directly fuels development, community growth, and long-term impact—while aligning your brand with meaningful, forward-thinking initiatives.

Read more about NgKore Foundation on its official page [**here**](https://ngkorefoundation.org/pages/about).
